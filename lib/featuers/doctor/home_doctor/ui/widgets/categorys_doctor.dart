...
class CategorysDoctors extends StatelessWidget {
  const CategorysDoctors({super.key});
      ...
      children: [
        Row(
          children: [
            GestureDetector(
              onTap: () {
                context.pushNamed(Routes.callsDoctors);
              },
              child: Container(
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        context.pushNamed(Routes.casesScreenDoctor);
                      },
                      child: Container(
                        width: 100.0.w,
                        height: 100.0.h,
